...
이번 실습에서 **위험한 명령을 자동 차단**하는 보안 훅을 직접 만듭니다. 자동화를 안전하게 만드는 실전 기술입니다.
...
목록에서 우리 훅을 확인하고 **검토 후 신뢰**합니다(보안상 새 명령 훅은 신뢰가 필요, 073번).

## Step 4. 동작 테스트 (안전하게)

> ⚠️ **진짜 위험 명령을 실행하지 마세요.** 차단되는지 "시도"만 합니다.
...
이 훅은 069번의 안전 모델을 **사용자 정의로 확장**한 것입니다.
...
기본 4겹 위에 **나만의 규칙**을 한 겹 더 얹은 셈입니다.
...
- 기본 4겹 위에 **커스텀 방어선**을 추가하는 고급 기법

---

다음 절에서 Codex의 말투를 바꾸는 **Personality 시스템**을 봅니다.
