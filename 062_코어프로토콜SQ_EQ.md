...
![그림 62-1. SQ/EQ 큐로 통신하는 엔진과 UI](images/062_sq_eq.png)
...
UI가 보내는 메시지를 **Submission**이라 하고, 그 내용(종류)을 **`Op`** 라고 부릅니다.
...
다음 절에서 작업의 단위 구조 — **Session · Task · Turn**을 봅니다.

> 📷 `images/062_sq_eq.png` — 부록 프롬프트 참고
