...
Codex는 출하 단계에서 **강한 Git 가드레일**을 내장하고 있습니다(066번에서 원문 해부). 핵심:
...
- ✋ 대화형 git(`rebase -i` 등)보다 **비대화형 명령**을 선호합니다.
...
> ⚠️ `git reset --hard`는 변경을 영구 삭제합니다. **정말 확실할 때만**, 그리고 직접.
...
다음 절에서 **IDE(VS Code/Cursor)에서 Codex 쓰기**를 다룹니다.
