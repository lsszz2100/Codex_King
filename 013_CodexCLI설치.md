...
![그림 13-1. 운영체제별 설치 경로](images/013_install.png)
...
- 설치는 **스크립트 한 줄**이 가장 쉽다 (Mac/Linux/Windows 각각 제공)
...
설치를 마쳤으니, 다음 절에서 **로그인하고 첫 실행**을 해봅시다.

> 📷 `images/013_install.png` — 부록 프롬프트 참고
